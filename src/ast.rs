#[derive(Debug, Clone)]
pub enum Stmt {
    VarDecl  { name: String, hash: u64, value: Expr, line: usize },
    Assign   { name: String, hash: u64, value: Expr, line: usize },
    ...
    FuncDef  { name: String, params: Vec<(String, u64)>, body: Vec<Stmt>, line: usize },
    ...
    For    { var: String, var_hash: u64, iter: Expr, body: Vec<Stmt>, line: usize },
...
pub enum Expr {
    ...
    Bool(bool),
    Null,
    Ident    { name: String, hash: u64, line: usize },
    Self_    { line: usize },
